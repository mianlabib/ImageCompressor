...
import { FaCompressAlt } from 'react-icons/fa'; // Importing the FaCompressAlt icon
...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* Main Header */}
      <nav className="w-full bg-blue-600 shadow-md p-4">
        {/* Changed background color to blue */}
        <div className="flex items-center justify-between max-w-screen-xl mx-auto">
          {/* Left side logo */}
          <div className="flex items-center space-x-2">
            <FaCompressAlt className="text-white text-3xl" />{' '}
